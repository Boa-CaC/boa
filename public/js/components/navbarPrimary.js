        ...
        <div class="menuPrincipal__wrappItems" data-state="close" role="dialog">
            ...
            <ul class="menuPrincipal__items">
                <li class="menuPrincipal__item">
                    <a href="http://boacac.alwaysdata.net/" class="menuPrincipal__link"><span class="mdi mdi-home"></span> Inicio</a>
                </li>
                <li class="menuPrincipal__item">
                    <a href="http://boacac.alwaysdata.net/mapa" class="menuPrincipal__link"><span class="mdi mdi-map"></span> Mapa de ofertas</a>
                </li>
                <li class="menuPrincipal__item">
                    <a href="http://boacac.alwaysdata.net/#faqs" class="menuPrincipal__link"><span class="mdi mdi-frequently-asked-questions"></span> Preguntas Frecuentes</a>
                </li>
                <li class="menuPrincipal__item">
                    <a href="http://boacac.alwaysdata.net/registro" class="menuPrincipal__link"><span class="mdi mdi-account-plus"></span> Registrarse</a>
                </li>
                <li class="menuPrincipal__item">
                    <a href="http://boacac.alwaysdata.net/login" class="menuPrincipal__link"><span class="mdi mdi-login"></span>Ingresar</a>
                </li>
            </ul>
        </div>
    </nav>
